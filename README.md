...
- [ipenywis/laya-ultrafast](https://github.com/ipenywis/laya-ultrafast) — The `browser-use/jev-ultrafast` browser-agent recipe rebuilt on Laya: the self-hosted open clone does the per-step decision work instead of the hosted model (67★, MIT, created 2026-09-21).
...
- [@evolving.ai: voice-controlled Mac assistant on Jev (IG reel, 2026-09-21)](https://www.instagram.com/reel/DdjIOcstTtn/) — Andy Gao's demo: the assistant starts acting before the spoken command finishes — opens Notes mid-sentence, creates a new note, opens Arc, Google-searches "Norbert Wiener", X.com, Photo Booth (8.8K likes). Commenters asking for the repo; not open-sourced yet.
